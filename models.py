...
class HeaderSection(Section):
    type: Literal["header"] = Field(..., description="Section type - 'header'",
                                    example="header")
    level: int = Field(
        ...,
...
class TitleSection(Section):
    type: Literal["title"] = Field(..., description="Section type - 'title'",
                                   example="title")
    text: str = Field(
        ...,
...
class LeadSection(Section):
    type: Literal["lead"] = Field(..., description="Section type - 'lead'",
                                  example="lead")
    text: str = Field(
        ...,
...
class TextSection(Section):
    type: Literal["text"] = Field(..., description="Section type - 'text'",
                                  example="text")
    text: str = Field(
        ...,
...
class ImageSection(Section):
    type: Literal["image"] = Field(..., description="Section type - 'image'",
                                   example="image")
    url: HttpUrl = Field(
...
class MediaSection(Section):
    type: Literal["media"] = Field(..., description="Section type - 'media'",
                                                    example="media")
    id: str = Field(
        ...,
    ...
    caption: Optional[str] = Field(
        None, description="Caption of the media",
                          example="This video shows a tutorial"
    )
    author: Optional[str] = Field(
        None, description="Name of the author of the media",
                          example="Some Author"
    )
    ...
    modification_date: Optional[datetime] = Field(
        None, description="Datetime of media modification",
                          example="2020-07-08T20:50:43Z"
    )
...
class Article(BaseModel):
    id: str = Field(..., description="Internal provider id",
                    example="article_id")
    ...
    categories: Optional[Set[str]] = Field(
        None, description="List of article categories",
                          example=["news", "local"]
    )
    ...
    author: Optional[str] = Field(
        None, description="Name of the author of the article",
                          example="Some Author"
    )
    publication_date: datetime = Field(
    ...
    sections: List[Union[SECTION_TYPES]] = None